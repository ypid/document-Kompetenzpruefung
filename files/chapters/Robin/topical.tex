...
geleitet. Diese Geräte sind am vielseitigsten einsetzbar, da der Teil hinter dem Ohr
ausreichend Platz für die Technik zur Verfügung stellt. So können mit diesen Hörgeräten hohe
Verstärkungsleistungen erreicht werde und viele Audiotransformationen durchgeführt werden.
...
versucht, näher an die Ursache zu kommen, um auch diese Fälle abdecken zu können. Dies geschieht mit
Implantaten. Da der Defekt an vielen Stellen liegen kann, wurden verschiedene Systeme entwickelt.

Eine Lösung kann ein Mittelohrimplantat sein. Es gibt mehrere Hersteller, die dieses Prinzip umsetzen.
...
\href{http://de.wikipedia.org/wiki/Schwerhörigkeit}{Schallleitungsschwerhörigkeit} auf,
deshalb muss die Verbindung der Gehörknöchelchenkette bei einem
...
Innenohrimplantat abgeraten, da es unwahrscheinlich ist, dass diese Menschen das Hören noch erlernen
können.
...
durchschnittlich 75 Jahren zum Einsatz kommen. Durch einen Herzschrittmacher werden
