...
Eine solche Brille oder später auch als
...
bekannt aus den Terminator Filmen und Serien.} Man könnte Messdaten vom eigenen
Körper, die über entsprechende Implantate erfasst werden,
...
Es könnte also ebenfalls\footnote{Wie auch schon bei der
...
An der Stelle könnte man endlos weiter philosophieren.
...
Implantat sein.
Die unautorisierte Manipulation solcher Geräte über die Funkschnittstelle war voraussehbar
und hätte nachhaltiger verhindert werden müssen.
...
Gerechtigkeit ist damit immer noch nicht gewährleistet. Ich könnte mir zum Beispiel
