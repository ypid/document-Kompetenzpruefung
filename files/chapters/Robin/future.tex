...
\end{wrapfigure}
\footnotetext{Zugeschnitten und Gedreht. Das Original, wie auch meine Abwandlung, stehen unter
\href{http://creativecommons.org/licenses/by-sa/2.0/de/deed.de}{Creative Commons BY-SA 2.0}.
Das Bild stammt vom Benutzer Wofl.}
%\end{comment}
...
solches Leuchtorgan, wie es bei Tieren\footnote{Hauptsächlich bei Meerestieren.} vorkommt, hat einen
extrem hohen Wirkungsgrad von bis zu 95\Prozent. Die Energie könnte direkt dem Blutkreislauf entzogen
werden\fxwarning{ATP im Blut vorhanden?}. So könnte ich mir, in den nächsten 15 Jahren, eine Lampe
