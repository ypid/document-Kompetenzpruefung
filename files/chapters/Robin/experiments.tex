\section{Eigener Versuche -- ein sechster Sinn}
...
\begin{wrapfigure}{r}{0pt}
	...
	\captionof{figure}{Zwei Vibrationsmotoren mit Gehäuse aus Holz}
...
\begin{comment}
Allerdings ist bei der Stärke der Vibration noch Optimierungspotenzial.
In meiner derzeitigen Umsetzung stören die Vibrationen nach längerem Tragen
des Gürtels mehr als sie nützen.
\end{comment}
...
\begin{wrapfigure}{r}{0pt} %% Einbindung steht im Konflikt mit dem Urheberrecht
	...
	\captionof{figure}[Magnete werden vom Ringfinger von Quinn Norton angezogen]%
...
Bei Festplatten habe ich allerdings nicht viel gesprüht. Das bleibt wohl denen vorbehalten, die
